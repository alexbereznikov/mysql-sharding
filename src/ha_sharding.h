...
*/
typedef struct st_sharding_share {
  char *table_name;
...
*/
class ha_sharding: public handler
{
  THR_LOCK_DATA lock;      ///< MySQL lock
  SHARDING_SHARE *share;    ///< Shared lock info

public:
  ha_sharding(handlerton *hton, TABLE_SHARE *table_arg);
  ~ha_sharding()
  {
  }
   ...
   */
  const char *table_type() const { return "SHARDING"; }
